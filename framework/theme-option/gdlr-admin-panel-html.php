<?php
	...
	*/	
	...
	class gdlr_lms_admin_option_html{
		...
		function print_font_combobox($settings = array()){
			...
			echo 'value="' . esc_attr( __('Sample Font', 'gdlr-lms') ) . '" ';
		...
		function print_skin_settings($settings = array()){
			...
			echo __('The skin you created can be used in Color / Background Wrapper Section', 'gdlr-lms');
			echo '</div>';
			echo '<div class="clear"></div>';
		...
		function print_upload_box($settings = array()){
			...
			echo 'data-button="';
			echo (empty($settings['button']))? __('Insert Image', 'gdlr-lms'):$settings['button'];
			echo '" ';
			echo 'value="' . __('Upload', 'gdlr-lms') . '"/>';
		...
		function print_upload_font($settings = array()){
			...
			echo '<div class="gdlr-upload-font-title">' . __('Upload font', 'gdlr-lms') . '</div>';
		...
		function print_font_item($value = array()){
			...
			echo '<span class="gdlr-font-input-label" >' . __('Font Name', 'gdlr-lms') . '</span>';
			...
			// eot type
			echo '<div class="gdlr-font-item">';
			echo '<span class="gdlr-font-input-label" >' . __('EOT Font', 'gdlr-lms') . '</span>';
			...
			echo '/>';
			echo '<input class="gdlr-upload-font-button gdl-button" type="button" value="' . __('Upload', 'gdlr-lms') . '" />';
			echo '<div class="clear"></div>';
			echo '</div>';
			
			// ttf format
			echo '<div class="gdlr-font-item last">';
			echo '<span class="gdlr-font-input-label" >' . __('TTF Font', 'gdlr-lms') . '</span>';
