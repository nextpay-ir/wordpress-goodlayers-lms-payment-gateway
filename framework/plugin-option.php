		...
		$lms_admin_option->set_option(array(
			'general' => array(
				...
				'options' => array(
                    ...
                    'nextpay-payment-info' => array(
                        'title' => __('Nextpay Info', 'gdlr-lms'),
                        'options' => array(
                            'nextpay-api-key' => array(
                                'title' => __('Nextpay Api Key', 'gdlr-lms'),
                                'type' => 'text',
                                'default' => '0'
                            ),
                            'nextpay-currency-code' => array(
                                'title' => __('Nextpay Currency Code ( IRR, IRT)', 'gdlr-lms'),
                                'type' => 'text',
                                'default' => 'IRT'
                            ),
                        )
